...
class DeepResearchAgent(BaseAgent):
    ...
    def get_system_prompt(self) -> str:
        return (
            ...
            "wants an open-access PDF found online, downloaded, ingested, and "
            ...
            "`find_and_ingest_open_access_pdf`, `draft_paper_section`, and "
            "`compile_paper`. Execute the user's whole "
